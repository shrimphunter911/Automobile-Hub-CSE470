...
function CategoryPage() {
    ...
    const productsSearch = cars.filter((car) => car.model.toLowerCase().includes(searchTerm.toLowerCase()));

    function ProductSearch({ _id, category, model, pictures }) {
        return <PreviewCar _id={_id} category={category} model={model} pictures={pictures} />;
    }
